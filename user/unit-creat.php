                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Input data User UNIT</p>
								<hr />
									...
									&nbsp;<a href="index.php?hal=user&act=permission"> Back to Report</a></p>	
								<hr />								
                            </div>
                            <div class="content">
<form class="form-horizontal" role="form" action="<?php echo $url_target;?>" method="POST">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="hidden" class="form-control input-sm" id="inputPassword3" placeholder="Level" name="level" value="3">
    </div>
  </div>
  <div class="form-group">
